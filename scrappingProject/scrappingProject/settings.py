"""
Django settings for scrappingProject project.
...
SECRET_KEY = 'django-insecure-m!id3i@a9&#s=u4#&&ea$vox$rr10jfm6xlr6zmc_su6kk!#5y'
...
INSTALLED_APPS = [
    ...
    'scrappingCenter.apps.ScrappingcenterConfig'
]
...
ROOT_URLCONF = 'scrappingProject.urls'
...
WSGI_APPLICATION = 'scrappingProject.wsgi.application'
